const Footer = () => {
  ...
  return (
    <footer className="bg-slate-900 text-white pt-20 pb-10 w-full relative rounded-t-[2.5rem] lg:rounded-t-[3rem] overflow-hidden mt-12">
      ...
      <div className="absolute top-[-10%] left-[20%] w-[30rem] h-[30rem] bg-[#00AEEF]/10 rounded-full filter blur-[80px] pointer-events-none z-0"></div>
      <div className="absolute bottom-[-10%] right-[10%] w-[20rem] h-[20rem] bg-[#FCE300]/5 rounded-full filter blur-[80px] pointer-events-none z-0"></div>
      ...
      <div className="px-6 lg:px-12 max-w-8xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 border-b border-white/10 pb-16">
          ...
          <div className="lg:col-span-2 pr-0 lg:pr-12">
            ...
            <div className="flex items-center gap-3 text-4xl font-black text-white mb-6 tracking-tight drop-shadow-sm">
              <img src="/logo.svg" alt="Privakom Logo" className="h-8 w-auto" />
              Privakom.
            </div>

            <p className="text-gray-400 font-medium text-lg lg:text-xl leading-relaxed mb-10 max-w-xl">
              Privakom Karawang adalah lembaga kursus komputer profesional yang menyediakan pelatihan Microsoft Office, Excel, Power BI, AutoCAD, Desain Grafis, Web Design, Teknisi Komputer, Networking, Cyber Security, serta Inhouse Training Perusahaan dengan instruktur berpengalaman dan sertifikat.
            </p>
...
>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4">
              <li className="group">
                <a
                  href="#about"
                  className="inline-flex items-center text-gray-400 font-bold text-sm hover:text-[#00AEEF] transition-colors"
                >
                  <span className="opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300 mr-2 text-[#00AEEF]">
                    ➔
                  </span>
                  About Us
                </a>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4">
              <li className="flex justify-between items-center border-b border-white/10 pb-4">
                ...
                <span className="bg-[#00AEEF]/20 text-[#00AEEF] font-bold px-4 py-1.5 rounded-full text-xs border border-cyan-500/30">
                  09:00 - 17:00
                </span>
              </li>
              <li className="flex justify-between items-center border-b border-white/10 pb-4">
                <span className="font-bold text-sm text-gray-300">Minggu</span>
                <span className="bg-white/5 text-gray-400 font-bold px-4 py-1.5 rounded-full text-xs border border-white/10">
                  Libur
                </span>
              </li>
            </ul>
            ...
            <div className="bg-cyan-900/20 border border-cyan-800/50 rounded-2xl p-4 mt-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-gray-500 font-medium text-sm">
          ...
          <div className="flex gap-6 mt-6 md:mt-0">
            <a
              href="#"
              className="hover:text-[#00AEEF] transition-colors hover:underline underline-offset-4"
            >
              Privacy Policy
            </a>
            <a
